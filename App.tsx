...
import { fetchReservations, createReservation, updateReservationStatusService } from './services/supabase';
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // Silent fail or show toast if needed, but keeping it clean for SaaS look
        // We don't want to show technical errors to public users
      } finally {
